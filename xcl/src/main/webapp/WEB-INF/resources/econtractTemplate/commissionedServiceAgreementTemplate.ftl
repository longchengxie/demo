<html xmlns="http://www.w3.org/1999/xhtml"> 
 ...
 <style type="text/css"> 
	* {margin:0;padding:0;}
	...
	.stamp{background:url() no-repeat;width:160px;height:160px;display:block;position:absolute;left:420px;top:0px;}
 ...
 <div class="txt-hetong">
    ...
    <br/><br/>
     <span style="float:right">合同编号：<em class="all-line" style="width:200px">　</em></span>
    <br/>
    <br/>
    <br/>
    <br/>
    ...
    <p>
        ...
        <b>联系电话：</b><em class="all-line" style="width:150px">　</em><br>
        <b>受托方（以下简称乙方）：</b><em class="all-line" style="width:220px"></em>
        <b>联系电话：</b><em class="all-line" style="width:150px">　</em><br>
        <br/>
     ...
     <table border="0" cellspacing="1" cellpadding="0" class="tab1">
		...
		<tr>			                        
		 <td><img src="${absolutePath!''}/image/checkedRadioButton.jpg" /></td>
		 <td><img src="${absolutePath!''}/image/checkedRadioButton.jpg" /></td>			                       
	     <td><img src="${absolutePath!''}/image/uncheckedCheckBox.jpg" /></td>
	     <td> 
		 </td>
		 <td> </td>
		</tr>
        <tr><td colspan="5">总订单支付金额￥ （如购买保险则含保险金额，否则不包含保险金额）</td></tr>
    ...
    <p style="text-aligh:left;">
     ...
     （二）甲乙双方在履行本协议过程中发生争议的，甲乙双方应协商解决，协商不成提交本合同签订地上海市嘉定区人民法院诉<br/>
                讼解决。<br/><br/>
   ...
   <p style="position: relative;">
     ...
     <span style="float:right">
        <em class="all-line" style="width:70px;">　 </em><b></b>
    </span>
